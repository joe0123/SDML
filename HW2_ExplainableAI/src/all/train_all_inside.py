...
if __name__ == "__main__":
    ...
    encoder_seq_len, encoder_input_data, decoder_seq_len, decoder_input_data, decoder_target_data, ctrl_seq_len, ctrl_sig_data = train_data_inside(char_index, texts)
